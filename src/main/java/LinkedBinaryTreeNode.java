...
public class LinkedBinaryTreeNode<E> implements BinaryTreeNode<E> {
    ...
    public ArrayList<BinaryTreeNode<E>> pathFrom(BinaryTreeNode<E> ancestor) {
        ArrayList<BinaryTreeNode<E>> path = new ArrayList<BinaryTreeNode<E>>();
    ...
    public int getHeight() {
        ...
        traversePreorder(node -> {
            maxDepth[0] = Math.max(node.getDepth(), maxDepth[0]);
        });
        return maxDepth[0];
    }
    ...
    public String toString() {
        return String.format("<BinaryTreeNode: %s, %s, %s>", data, leftChild == null ? null : leftChild.getData(), rightChild == null ? null : rightChild.getData());
    }

    public static void main(String[] args) {
        LinkedBinaryTreeNode<Integer> node1 = new LinkedBinaryTreeNode<Integer>(1);
        LinkedBinaryTreeNode<Integer> node2 = new LinkedBinaryTreeNode<Integer>(2);
        LinkedBinaryTreeNode<Integer> node3 = new LinkedBinaryTreeNode<Integer>(3);
        LinkedBinaryTreeNode<Integer> node4 = new LinkedBinaryTreeNode<Integer>(4);
        LinkedBinaryTreeNode<Integer> node5 = new LinkedBinaryTreeNode<Integer>(5);
